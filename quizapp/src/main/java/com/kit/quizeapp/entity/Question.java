...
public class Question {
	...
	public Question(int id, String questionTitle, String option1, String option2, String option3, String option4,
			String rightAnswer, String difficultyLevel, String regNumber, String difficultyLabel, String category) {
		super();
		this.id = id;
	...
	public String toString() {
		return "Question [id=" + id + ", questionTitle=" + questionTitle + ", option1=" + option1 + ", option2="
				...
				+ ", difficultyLevel=" + difficultyLevel + ", regNumber=" + regNumber + ", difficultyLabel="
				+ difficultyLabel + ", category=" + category + "]";
	}
